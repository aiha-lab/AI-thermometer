...
# Utility functions
import utils.inference8_test as inference_utils # TRT/TF inference wrappers
import utils.model_test as model_utils # UFF conversion
...
def produce_tensorrt_detections(trt_inference_wrapper, max_batch_size,
    ...
    for idx in range(0, len(image_numbers), max_batch_size):
        ...
        detections, inf_time = trt_inference_wrapper.infer_batch(image_paths, inf_time)
...
if __name__ == '__main__':
    ...
    if parsed['inference_backend'] == 'tensorrt':
        ssd_model_uff_path = PATHS.get_model_uff_path_test(MODEL_NAME)
    ...
    if parsed['inference_backend'] == 'tensorrt':
        ...
        produce_tensorrt_detections(trt_inference_wrapper, 
                parsed['max_batch_size'], voc_image_numbers, voc_image_path)
