...
class Paths(object):
    def __init__(self):
        ...
        self._WIDER_DIR_PATH = \
            os.path.join(self._SAMPLE_ROOT, 'WIDER')
    ...
    def get_wider_dir_path(self):
        return self._WIDER_DIR_PATH
    ...
    def get_model_uff_path_test(self, model_name):
        return os.path.join(
            self.get_model_dir_path(model_name),
            'frozen_inference_graph_test.uff'
        )
