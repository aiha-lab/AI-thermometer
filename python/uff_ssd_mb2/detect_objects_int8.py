...
from calibrator import load_mnist_data, load_mnist_labels, VOCEntropyCalibrator
import common
...
def main():
    ...
    calib = None
    calibration_cache = "ssd_calibration.cache"

    
    if args.trt_engine_datatype == trt.DataType.INT8:
