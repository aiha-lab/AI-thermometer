...
from utils.paths_test import PATHS
...
class ModelData(object):
    ...
    # Name of output node
    OUTPUT_NAME = "FeatureExtractor/MobilenetV2/layer_19_2_Conv2d_5_3x3_s2_128/Relu6"
...
def prepare_ssd_model(model_name="ssd_inception_v2_coco_2017_11_17", silent=False):
    ...
    Args:
        ...
        silent (bool): if False, writes progress messages to stdout
    """
    if model_name != "ssd_mobilenet_v2_coco_2018_03_29":
    ...
    ssd_uff_path = PATHS.get_model_uff_path_test(model_name)
